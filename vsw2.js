...
(function() { // IIFE for VSW
    ...
    */
    ...
    window.vsw_slideVideo = function(direction){ // इसे विंडो ऑब्जेक्ट पर रखें ताकि HTML से एक्सेस किया जा सके
    ...
    window.vsw_performSearch = function(searchBoxId){ // इसे विंडो ऑब्जेक्ट पर रखें ताकि HTML से एक्सेस किया जा सके
